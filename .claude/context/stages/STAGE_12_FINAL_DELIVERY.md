...
**Phase:** 5 - Evaluate  
**Duration:** 1 day  
**Primary Agents:** `project-manager`, `cloud-architect`, `business-analyst`, `document-writer`
...
3. **Document Creation**
   - `document-writer` copies templates to `deliverables/`
   - `document-writer` captures all information in appropriate sections
...
| `document-writer` | Create and populate documents |
...
|-------------|----------|-------|
| As-Built Document | `deliverables/AS_BUILT.md` | `document-writer` |
| Post-Mortem Document | `deliverables/POST_MORTEM.md` | `document-writer` |
